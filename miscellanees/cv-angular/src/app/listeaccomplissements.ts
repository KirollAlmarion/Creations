...
export const DEVELOPPEUR : number = 0,
             ...
             listeAccomplissements: Accomplissement[] = [
                ...
                },
                {
                    ...
                    cadre: "Fortuna",
                    lieu: "Noisy-le-Grand",
                    descriptif: "Création <em>de novo</em> du site de l'association d'évocation historique Fortuna : <a href='http://www.association-fortuna.com' target='_blank' rel='noopener noreferrer'>http://www.association-fortuna.com</a>.",
                    periode: "2020",
                    actif: false,
                    competencesLiees: [
                        {nom: ANALYSE, progression: 10},
                ...
                },
                {
                    ...
                    cadre: "Dawan",
                    lieu: "Paris",
                    descriptif: "Acquisition des compétences pour développer des applications .NET (399 heures) et certification <strong>Microsoft 98&#8209;361 Software Development Fundamentals</strong> (85/100).",
                    periode: "2020 2021",
                    actif: false,
                    competencesLiees: [
